...
public class JavaDBConnectionConfiguration extends AbstractConnectionConfiguration implements ConnectionConfiguration {
	public static final Integer[] JAVADB_IGNORED_CREATION_ERRORS = new Integer[] { 30000 };
	public static final File RECETAS_JAVADB_SQL_FILE = new File(DIR_SQL, "opiniones.javadb.sql");
